...
q_0=[1  angle_of_attack  5.2  0];  %initial conditions [y theta xdot ydot]
...
for i=1:500
   data(i).apex_state = [q_0(1)   angle_of_attack   q_0(3)    0];
   ...
   if events_flight_1 == 1
    ...
    time = time - t(end);
       ...
       y_liftoff = r_0*cos(q_0(2));
       theta_liftoff = q_0(2);
       xdot_liftoff = -sin(q_0(2))*q_0(3)-r_0*cos(q_0(2))*q_0(4);
       ydot_liftoff = cos(q_0(2))*q_0(3) - r_0*sin(q_0(2))*q_0(4);
   ...
   plot(data(i).apex_state(:,3),data(i).apex_state(:,1),'*');
    xlabel('xdot');
