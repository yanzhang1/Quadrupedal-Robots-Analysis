...
%% 
   ...
   if events_flight_1 == 1
       ...
       thetadot_touchdown=(-cos(u_0)*q_1(2)-sin(u_0)*q_1(3))/r_0;
       
    [t,q,~,~,events_stance] =ode45(@stance_motion, [0,time] ,...
        [r_0  u_0  rdot_touchdown  thetadot_touchdown], options_stance);
