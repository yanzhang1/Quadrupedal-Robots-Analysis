function Performance = Poincare_Map2(q_0,la,Kp,Kd)
%% 
g=9.8;                         %gravity acceleration 
k=3520;                         %spring constant
m=20.865;                        %torso mass
l_0=0.323;                       %rest lengt,h of leg
L = 0.276;                       % half length of torso
I = 1.3;
q_7 = [-10000 -10000 -10000 -10000];
...
z = 17;
[alpha3,delta,alpha6] = BezierPolynomial_BS(z,backstance_0);
...
%Before this motion, indicate what is 'x_btoe'
z = 17;
[alpha3,delta,alpha6] = BezierPolynomial_FS(z,frontstance_0);
