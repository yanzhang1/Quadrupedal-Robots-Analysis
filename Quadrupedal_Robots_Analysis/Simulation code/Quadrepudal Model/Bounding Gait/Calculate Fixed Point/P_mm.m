...
%b = 53;
%u_0 = [0.23, 0.193 ];
%u_0 = [0.23470, 0.184130];
%u_0 = [0.232570, 0.184130];
%u_0 = [phi_bTD,phi_fTD]
%u_0(1) = [phi_bTD] back leg touchdown angle
%u_0(2) = [phi_fTD] front leg touchdown angle
%q_0 = [0.325814	 -0.000000	 0.673839	 6.117373];
%q_0 = [y,theta,xdot,thetadot]
%q_0=[0.3337  0.0000  0.7083  4.9305];
%q_0 = [0.337162586025046,-1.213624675818948e-10,0.7074762078205445,5.175929144385664];
%q_0 = [0.337162586025046,-1.213624675818948e-10,0.704762078205445,5.175929144385664]
...
%hold on
 %for i =1:20
   ...
   [t1,q,~,~,events_flight_1] =ode45(@flight_motion, [t0,time] , [x0 , q_0(1), q_0(2) ,q_0(3),  0 , q_0(4)], options_flight_1);
   time1 = t1+tt_end;
   ...
   x_btoe = q_1(1) - L*cos(q_1(3)) + l_0*sin(u_0(1));
    ...
    if events_back_stance == 1 
        ...
        %%%%%%%%%
     %   xposition_hip = q_2(1) + L*cos(q_2(3));
     %   yposition_hip = q_2(2) - L*sin(q_2(3));         
        %u_0(2) = u_0(1);
      %  u_0(2) = abs(atan((xposition_hip - x_btoe)/yposition_hip));
       % xposition_hip = q_2(1) - L*cos(q_2(3));
       % yposition_hip = q_2(2) - L*sin(q_2(3));         
       % u_0(1) = u_0(2);
        %%%%%%%%%
        ...
        if events_flight_3 == 1
            ...
            x_ftoe= l_0*sin(u_0(2)) + q_4(1) + L*cos(q_4(3));
              ...
              time =time - t5(end);
                  ...
                  q_9=[q(end,2),q(end,3),q(end,4),q(end,6)];
